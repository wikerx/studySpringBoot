...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('quartzScheduler', 'PC-Xue1551681925180', '1551682880991', '15000');
...
CREATE TABLE `sys_log` (
  ...
  `gmt_create` datetime default NULL COMMENT '创建时间',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=772 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `sys_log` VALUES ('768', '-1', '获取用户信息为空', '登录', '2', 'com.scott.dp.modules.sys.controller.SysLoginController.login()', '{\"errorMsg\":\"验证码错误\"}', '0:0:0:0:0:0:0:1', '2019-03-01 18:58:47');
INSERT INTO `sys_log` VALUES ('769', '1', 'admin', '登录', '103', 'com.scott.dp.modules.sys.controller.SysLoginController.login()', '{}', '0:0:0:0:0:0:0:1', '2019-03-01 18:58:54');
INSERT INTO `sys_log` VALUES ('770', '1', 'admin', '新增字典', '132', 'com.scott.dp.modules.sys.controller.SysMacroController.save()', '{\"macroId\":null,\"typeId\":0,\"typeName\":null,\"name\":\"数据库标识\",\"value\":\"dbname\",\"status\":1,\"type\":1,\"orderNum\":0,\"remark\":\"数据库标识\",\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2019-03-01 18:59:45');
INSERT INTO `sys_log` VALUES ('771', '1', 'admin', '登录', '114', 'com.scott.dp.modules.sys.controller.SysLoginController.login()', '{}', '0:0:0:0:0:0:0:1', '2019-03-04 10:08:31');
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='通用字典表';

-- ----------------------------
-- Records of sys_macro
-- ----------------------------
INSERT INTO `sys_macro` VALUES ('1', '0', '数据库标识', 'dbname', '1', '1', '0', '数据库标识', '2019-03-01 18:59:45', null);
